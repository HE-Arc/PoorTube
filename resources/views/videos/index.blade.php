  ...
  <div class="column is-8 is-offset-2">
    ...
    <div class="card article">
      <div class="card-content">
        ...
        @endphp
        @if ( $exist == true )
        <a href="{{ route('videos.like', $video->id, Auth::id()) }}" ><i id="likeButton" class="fas fa-heart icon is-medium"></i></a>
        @else
        <a href="{{ route('videos.like', $video->id, Auth::id()) }}" ><i class="far fa-heart icon is-medium"></i></a>
        @endif
